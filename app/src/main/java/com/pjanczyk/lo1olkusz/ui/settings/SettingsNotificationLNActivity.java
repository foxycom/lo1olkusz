...
public class SettingsNotificationLNActivity extends AppCompatPreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.settings_notification_ln);

        CheckBoxPreference prefNotify = (CheckBoxPreference) findPreference(getString(R.string.ln_notify_key));
